/**************************************************************************
 ...
 Modifications: PT 4-26-2018 Updated with 4/26/2018 download.
        ...
        PT 7-10-2026 New version for new input file structure
          SSL,MARID,SQUARE,SUFFIX,LOT,COL,PARCEL,RESERVATION,LOT_TYPE,OBJECTID
**************************************************************************/
...
%let revisions = Updated with 7/10/2026 download.;


filename fimport "&_dcdata_r_path\MAR\Raw\2026-07-10\Address_and_Square_Suffix_Lot_Cross_Reference.csv" lrecl=256;
